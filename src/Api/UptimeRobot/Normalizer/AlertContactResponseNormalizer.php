...
class AlertContactResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ConnectHolland\\UptimeRobotBundle\\Api\\UptimeRobot\\Model\\AlertContactResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'ConnectHolland\\UptimeRobotBundle\\Api\\UptimeRobot\\Model\\AlertContactResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \ConnectHolland\UptimeRobotBundle\Api\UptimeRobot\Model\AlertContactResponse();
        ...
        if (property_exists($data, 'alertcontact') && $data->{'alertcontact'} !== null) {
            $object->setAlertcontact($this->denormalizer->denormalize($data->{'alertcontact'}, 'ConnectHolland\\UptimeRobotBundle\\Api\\UptimeRobot\\Model\\AlertContact', 'json', $context));
        } elseif (property_exists($data, 'alertcontact') && $data->{'alertcontact'} === null) {
